...
if (isset($_SESSION['ONLINE-EXAM-SIMULATOR-ADMIN-USER']) || isset($_SESSION['FirstTime']))
{

		 $password_random = ''; 
 						if( isset( $_GET['password_random'])){
		 					$password_random = $_GET['password_random'];
...
<?php 
 	...
 	$isPasswordError = ''; 
 					if( isset( $_GET['isPasswordError'])){
		 					$isPasswordError = $_GET['isPasswordError'];
		 					}
if ($isPasswordError)
{
